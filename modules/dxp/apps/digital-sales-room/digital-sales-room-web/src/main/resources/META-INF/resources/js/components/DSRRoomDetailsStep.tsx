...
import {TDSRContext} from './DSRTypes';
...
function DSRRoomDetailsStep({numberOfSteps, setHandleStepSubmit}: Props) {
	...
	return (
		<>
			<div>
				...
				<div className="mb-1 text-6 text-weight-bold">
			...
			<div className="mt-4 row">
				...
				>
					...
					<div className="align-items-center d-flex">
						<Sticker className="mr-2" shape="user-icon" size="xxl">
							<Sticker.Image
								...
								src={
									...
									'https://clayui.com/images/long_user_image.png'
								}
							/>
						</Sticker>
						...
						<ClayButton
							className="ml-2"
							data-qa-id="dsr-client-logo-button"
							displayType="primary"
						...
						{dataContext.clientLogo.base64 && (
							<ClayButton
								className="ml-3"
								data-qa-id="dsr-client-logo-delete-button"
					...
					<FieldErrorMessage error={dataContext.errors.clientLogo} />
				</ClayForm.Group>
			</div>
			<div className="row">
				<ClayForm.Group
				...
				>
					...
					<FieldErrorMessage error={dataContext.errors.clientName} />
				</ClayForm.Group>
				...
				>
					...
					<FieldErrorMessage error={dataContext.errors.roomName} />
				</ClayForm.Group>
			</div>
			<div className="row">
				<ClayForm.Group
				...
				>
					...
					<FieldErrorMessage error={dataContext.errors.banner} />
				</ClayForm.Group>
			</div>
			<div className="row">
				<ClayForm.Group
			...
			<div className="row">
				...
				>
					...
					<FieldErrorMessage error={dataContext.errors.friendlyURL} />
				</ClayForm.Group>
			</div>
		</>
	);
