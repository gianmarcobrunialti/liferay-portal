...
export class DSRAnalyticsPage {
	...
	constructor(page: Page) {
		...
		this.roomFilterMenu = page.locator('.room-filter-dropdown');
		...
		this.userFilterMenu = page.locator('.user-filter-dropdown');
	...
	roomFilterOption(name: string): Locator {
		return this.roomFilterMenu.getByRole('menuitem').filter({hasText: name});
	}
	...
	userFilterOption(name: string): Locator {
		return this.userFilterMenu.getByRole('menuitem').filter({hasText: name});
	}
}
