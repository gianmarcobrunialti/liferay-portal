...
public abstract class BaseDocumentMetricResourceImpl
	implements DocumentMetricResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/documents'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "DocumentMetric")
		}
	)
	@jakarta.ws.rs.GET
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseDocumentMetricResourceImpl.class);

}
// LIFERAY-REST-BUILDER-HASH:142948707