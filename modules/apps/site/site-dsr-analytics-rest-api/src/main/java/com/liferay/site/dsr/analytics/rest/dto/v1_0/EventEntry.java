 ...
 */
@Generated("")
@GraphQLName("EventEntry")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EventEntry")
public class EventEntry implements Serializable {

	public static EventEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(EventEntry.class, json);
	}

	public static EventEntry unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EventEntry.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.EventEntry",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-29812644