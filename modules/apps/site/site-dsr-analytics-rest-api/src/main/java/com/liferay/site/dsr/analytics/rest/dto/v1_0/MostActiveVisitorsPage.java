 ...
 */
@Generated("")
@GraphQLName("MostActiveVisitorsPage")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MostActiveVisitorsPage")
public class MostActiveVisitorsPage implements Serializable {

	public static MostActiveVisitorsPage toDTO(String json) {
		return ObjectMapperUtil.readValue(MostActiveVisitorsPage.class, json);
	}

	public static MostActiveVisitorsPage unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			MostActiveVisitorsPage.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema
	@Valid
	public MostActiveVisitor[] getMostActiveVisitors() {
		if (_mostActiveVisitorsSupplier != null) {
			mostActiveVisitors = _mostActiveVisitorsSupplier.get();

			_mostActiveVisitorsSupplier = null;
		}
	...
	public void setMostActiveVisitors(
		...
		_mostActiveVisitorsSupplier = () -> {
			try {
				return mostActiveVisitorsUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<MostActiveVisitor[]> _mostActiveVisitorsSupplier;
	...
	public String toString() {
		...
		MostActiveVisitor[] mostActiveVisitors = getMostActiveVisitors();
		...
		if (mostActiveVisitors != null) {
			...
			for (int i = 0; i < mostActiveVisitors.length; i++) {
				sb.append(String.valueOf(mostActiveVisitors[i]));

				if ((i + 1) < mostActiveVisitors.length) {
					sb.append(", ");
				}
			}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.MostActiveVisitorsPage",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1223078962