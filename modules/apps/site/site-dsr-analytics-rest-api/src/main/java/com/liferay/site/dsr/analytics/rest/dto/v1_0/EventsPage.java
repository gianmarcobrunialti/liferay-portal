 ...
 */
@Generated("")
@GraphQLName("EventsPage")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EventsPage")
public class EventsPage implements Serializable {

	public static EventsPage toDTO(String json) {
		return ObjectMapperUtil.readValue(EventsPage.class, json);
	}

	public static EventsPage unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EventsPage.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.EventsPage",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:365729395