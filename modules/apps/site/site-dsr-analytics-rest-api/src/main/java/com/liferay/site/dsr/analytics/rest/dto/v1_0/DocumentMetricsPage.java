 ...
 */
@Generated("")
@GraphQLName("DocumentMetricsPage")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DocumentMetricsPage")
public class DocumentMetricsPage implements Serializable {

	public static DocumentMetricsPage toDTO(String json) {
		return ObjectMapperUtil.readValue(DocumentMetricsPage.class, json);
	}

	public static DocumentMetricsPage unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			DocumentMetricsPage.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.DocumentMetricsPage",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-609067950