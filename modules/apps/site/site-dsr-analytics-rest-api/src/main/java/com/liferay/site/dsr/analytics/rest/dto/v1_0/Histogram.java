...
public class Histogram implements Serializable {
	...
	public Double getAsymmetricComparison() {
		if (_asymmetricComparisonSupplier != null) {
			asymmetricComparison = _asymmetricComparisonSupplier.get();

			_asymmetricComparisonSupplier = null;
		}

		return asymmetricComparison;
	}

	public void setAsymmetricComparison(Double asymmetricComparison) {
	...
	@JsonIgnore
	public void setAsymmetricComparison(
		UnsafeSupplier<Double, Exception> asymmetricComparisonUnsafeSupplier) {

		_asymmetricComparisonSupplier = () -> {
			try {
				return asymmetricComparisonUnsafeSupplier.get();
			}
	...
	protected Double asymmetricComparison;

	@JsonIgnore
	private Supplier<Double> _asymmetricComparisonSupplier;
	...
	public String toString() {
		...
		Double asymmetricComparison = getAsymmetricComparison();

		if (asymmetricComparison != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
...
// LIFERAY-REST-BUILDER-HASH:224046479