...
public abstract class BaseUserSessionResourceTestCase {
	...
	@Test
	public void testGetEventsByUserSession() throws Exception {
		UserSession postUserSession = testGetUserSession_addUserSession();

		UserSessionsPage postUserSessionsPage =
			testGetEventsByUserSession_addUserSessionsPage(
				postUserSession.getUserSessionId(), randomUserSessionsPage());

		UserSessionsPage getUserSessionsPage =
			userSessionResource.getEventsByUserSession(
				postUserSession.getUserSessionId());

		assertEquals(postUserSessionsPage, getUserSessionsPage);
		assertValid(getUserSessionsPage);
	}

	protected UserSessionsPage testGetEventsByUserSession_addUserSessionsPage(
			long userSessionId, UserSessionsPage userSessionsPage)
		throws Exception {
	...
	protected void assertEquals(
		UserSessionsPage userSessionsPage1,
		UserSessionsPage userSessionsPage2) {

		Assert.assertTrue(
			userSessionsPage1 + " does not equal " + userSessionsPage2,
			equals(userSessionsPage1, userSessionsPage2));
	}
	...
	protected void assertValid(UserSessionsPage userSessionsPage) {
		boolean valid = true;

		for (String additionalAssertFieldName :
				getAdditionalUserSessionsPageAssertFieldNames()) {
	...
	protected String[] getAdditionalUserSessionsPageAssertFieldNames() {
		return new String[0];
	}
	...
	protected boolean equals(
		...
		if (userSessionsPage1 == userSessionsPage2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("totalEvents", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						userSessionsPage1.getTotalEvents(),
						userSessionsPage2.getTotalEvents())) {
			...
			if (Objects.equals("userSessions", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						userSessionsPage1.getUserSessions(),
						userSessionsPage2.getUserSessions())) {
	...
	protected UserSessionsPage randomUserSessionsPage() throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:984369821