...
public abstract class BaseMostActiveVisitorResourceTestCase {
	...
	public void testGetMostActiveVisitor() throws Exception {
		...
		MostActiveVisitorsPage postMostActiveVisitorsPage =
			testGetMostActiveVisitor_addMostActiveVisitorsPage(
				postMostActiveVisitor.getId(), randomMostActiveVisitorsPage());

		MostActiveVisitorsPage getMostActiveVisitorsPage =
			mostActiveVisitorResource.getMostActiveVisitor(
				postMostActiveVisitor.getId());

		assertEquals(postMostActiveVisitorsPage, getMostActiveVisitorsPage);
		assertValid(getMostActiveVisitorsPage);
	}

	protected MostActiveVisitorsPage
			testGetMostActiveVisitor_addMostActiveVisitorsPage(
				long mostActiveVisitorId,
	...
	protected void assertEquals(
		MostActiveVisitorsPage mostActiveVisitorsPage1,
		MostActiveVisitorsPage mostActiveVisitorsPage2) {

		Assert.assertTrue(
			mostActiveVisitorsPage1 + " does not equal " +
				mostActiveVisitorsPage2,
			equals(mostActiveVisitorsPage1, mostActiveVisitorsPage2));
	}
	...
	protected void assertValid(MostActiveVisitorsPage mostActiveVisitorsPage) {
		boolean valid = true;

		for (String additionalAssertFieldName :
				getAdditionalMostActiveVisitorsPageAssertFieldNames()) {
	...
	protected String[] getAdditionalMostActiveVisitorsPageAssertFieldNames() {
		return new String[0];
	}
	...
	protected boolean equals(
		...
		if (mostActiveVisitorsPage1 == mostActiveVisitorsPage2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						mostActiveVisitorsPage1.getMostActiveVisitors(),
						mostActiveVisitorsPage2.getMostActiveVisitors())) {
			...
			if (Objects.equals("total", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						mostActiveVisitorsPage1.getTotal(),
						mostActiveVisitorsPage2.getTotal())) {
	...
	protected MostActiveVisitorsPage randomMostActiveVisitorsPage()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-1544824957