...
public abstract class BaseDocumentMetricResourceTestCase {
	...
	public void testGetDocument() throws Exception {
		...
		DocumentMetricsPage postDocumentMetricsPage =
			testGetDocument_addDocumentMetricsPage(
				postDocumentMetric.getDocumentMetricId(),
				randomDocumentMetricsPage());

		DocumentMetricsPage getDocumentMetricsPage =
			documentMetricResource.getDocument(
				postDocumentMetric.getDocumentMetricId());

		assertEquals(postDocumentMetricsPage, getDocumentMetricsPage);
		assertValid(getDocumentMetricsPage);
	}

	protected DocumentMetricsPage testGetDocument_addDocumentMetricsPage(
			long documentMetricId, DocumentMetricsPage documentMetricsPage)
		throws Exception {
	...
	protected void assertEquals(
		DocumentMetricsPage documentMetricsPage1,
		DocumentMetricsPage documentMetricsPage2) {

		Assert.assertTrue(
			documentMetricsPage1 + " does not equal " + documentMetricsPage2,
			equals(documentMetricsPage1, documentMetricsPage2));
	}
	...
	protected void assertValid(DocumentMetricsPage documentMetricsPage) {
		boolean valid = true;

		for (String additionalAssertFieldName :
				getAdditionalDocumentMetricsPageAssertFieldNames()) {
	...
	protected String[] getAdditionalDocumentMetricsPageAssertFieldNames() {
		return new String[0];
	}
	...
	protected boolean equals(
		...
		if (documentMetricsPage1 == documentMetricsPage2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("documentMetrics", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentMetricsPage1.getDocumentMetrics(),
						documentMetricsPage2.getDocumentMetrics())) {
			...
			if (Objects.equals("total", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentMetricsPage1.getTotal(),
						documentMetricsPage2.getTotal())) {
	...
	protected DocumentMetricsPage randomDocumentMetricsPage() throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:2018908921