 ...
 */
@Generated("")
public interface VisitFrequencyResource {
	...
	public HttpInvoker.HttpResponse getVisitFrequencyHttpResponse(
	...
	public static class Builder {
		...
		public VisitFrequencyResource build() {
			return new VisitFrequencyResourceImpl(this);
		}
	...
	public static class VisitFrequencyResourceImpl
		...
		public VisitFrequency getVisitFrequency(
			...
			HttpInvoker.HttpResponse httpResponse =
				getVisitFrequencyHttpResponse(channelId, rangeKey);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/visit-frequency");
		...
		private VisitFrequencyResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			VisitFrequencyResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:321278124