...
public interface UserSessionResource {
	...
	public HttpInvoker.HttpResponse getEventsByUserSessionHttpResponse(
			String channelId, String entityType, String keywords, Integer page,
			String rangeEnd, Integer rangeKey, String rangeStart, Integer size)
		throws Exception;
	...
	public static class Builder {
		...
		public UserSessionResource build() {
			return new UserSessionResourceImpl(this);
		}
	...
	public static class UserSessionResourceImpl implements UserSessionResource {

		public UserSessionsPage getEventsByUserSession(
				String channelId, String entityType, String keywords,
				Integer page, String rangeEnd, Integer rangeKey,
				String rangeStart, Integer size)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getEventsByUserSessionHttpResponse(
			...
			try {
				return UserSessionsPageSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/events-by-user-sessions");
		...
		private UserSessionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			UserSessionResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-1370876157