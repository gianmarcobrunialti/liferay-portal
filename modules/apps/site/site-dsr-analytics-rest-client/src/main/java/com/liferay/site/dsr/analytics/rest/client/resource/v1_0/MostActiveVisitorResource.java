 ...
 */
@Generated("")
public interface MostActiveVisitorResource {
	...
	public HttpInvoker.HttpResponse getMostActiveVisitorHttpResponse(
			String channelId, Integer rangeKey, Integer size, Integer start)
		throws Exception;
	...
	public static class Builder {
		...
		public MostActiveVisitorResource build() {
			return new MostActiveVisitorResourceImpl(this);
		}
	...
	public static class MostActiveVisitorResourceImpl
		...
		public MostActiveVisitorsPage getMostActiveVisitor(
			...
			HttpInvoker.HttpResponse httpResponse =
				getMostActiveVisitorHttpResponse(
			...
			try {
				return MostActiveVisitorsPageSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private MostActiveVisitorResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			MostActiveVisitorResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-203743070