 ...
 */
@Generated("")
public interface SiteVisitorsMetricResource {
	...
	public HttpInvoker.HttpResponse getSiteVisitorsMetricHttpResponse(
			String channelId, String interval, String rangeEnd,
			Integer rangeKey, String rangeStart)
		throws Exception;
	...
	public static class Builder {
		...
		public SiteVisitorsMetricResource build() {
			return new SiteVisitorsMetricResourceImpl(this);
		}
	...
	public static class SiteVisitorsMetricResourceImpl
		implements SiteVisitorsMetricResource {
		...
		public SiteHistogramMetric getSiteVisitorsMetric(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteVisitorsMetricHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/site-visitors-metric");
		...
		private SiteVisitorsMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SiteVisitorsMetricResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:948097412