 ...
 */
@Generated("")
public interface DocumentMetricResource {
	...
	public HttpInvoker.HttpResponse getDocumentHttpResponse(
			String channelId, String keywords, String rangeEnd,
			Integer rangeKey, String rangeStart, Integer size,
			String sortColumn, String sortType, Integer start)
		throws Exception;
	...
	public static class Builder {
		...
		public DocumentMetricResource build() {
			return new DocumentMetricResourceImpl(this);
		}
	...
	public static class DocumentMetricResourceImpl
		implements DocumentMetricResource {
		...
		public DocumentMetricsPage getDocument(
			...
			try {
				return DocumentMetricsPageSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/documents");
		...
		private DocumentMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DocumentMetricResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:1622137341