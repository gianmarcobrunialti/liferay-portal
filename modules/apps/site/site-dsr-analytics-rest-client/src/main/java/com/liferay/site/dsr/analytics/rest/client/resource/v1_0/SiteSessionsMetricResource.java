 ...
 */
@Generated("")
public interface SiteSessionsMetricResource {
	...
	public HttpInvoker.HttpResponse getSiteSessionsMetricHttpResponse(
			String channelId, String[] emailAddresses, String interval,
			String rangeEnd, Integer rangeKey, String rangeStart)
		throws Exception;
	...
	public static class Builder {
		...
		public SiteSessionsMetricResource build() {
			return new SiteSessionsMetricResourceImpl(this);
		}
	...
	public static class SiteSessionsMetricResourceImpl
		implements SiteSessionsMetricResource {
		...
		public SiteHistogramMetric getSiteSessionsMetric(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteSessionsMetricHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/site-sessions-metric");
		...
		private SiteSessionsMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SiteSessionsMetricResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:929985650