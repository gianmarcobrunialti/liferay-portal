...
public interface EventResource {
	...
	public HttpInvoker.HttpResponse getEventHttpResponse(
			String channelId, Boolean includeAnonymousUsers,
			String individualId, String keywords, Integer page, String rangeEnd,
			Integer rangeKey, String rangeStart, Integer size)
		throws Exception;
	...
	public static class EventResourceImpl implements EventResource {
		...
		public EventsPage getEvent(
			...
			HttpInvoker.HttpResponse httpResponse = getEventHttpResponse(
			...
			try {
				return EventsPageSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
...
// LIFERAY-REST-BUILDER-HASH:1369580172