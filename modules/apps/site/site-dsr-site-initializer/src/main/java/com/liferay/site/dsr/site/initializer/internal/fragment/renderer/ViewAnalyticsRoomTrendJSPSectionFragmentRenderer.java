...
import com.liferay.site.dsr.site.initializer.internal.display.context.ViewAnalyticsRoomTrendSectionDisplayContext;
...
public class ViewAnalyticsRoomTrendJSPSectionFragmentRenderer
	extends BaseJSPSectionFragmentRenderer<ViewAnalyticsRoomTrendSectionDisplayContext> {
	...
	protected ViewAnalyticsRoomTrendSectionDisplayContext getDisplayContext(
		...
		return new ViewAnalyticsRoomTrendSectionDisplayContext(
			httpServletRequest,
