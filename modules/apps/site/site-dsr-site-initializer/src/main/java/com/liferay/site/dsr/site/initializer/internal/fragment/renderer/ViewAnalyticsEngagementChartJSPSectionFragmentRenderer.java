...
public class ViewAnalyticsEngagementChartJSPSectionFragmentRenderer
	extends BaseJSPSectionFragmentRenderer<ViewAnalyticsEngagementChartSectionDisplayContext> {
	...
	@Override
	protected ViewAnalyticsEngagementChartSectionDisplayContext getDisplayContext(
		...
		return new ViewAnalyticsEngagementChartSectionDisplayContext(
			httpServletRequest,
