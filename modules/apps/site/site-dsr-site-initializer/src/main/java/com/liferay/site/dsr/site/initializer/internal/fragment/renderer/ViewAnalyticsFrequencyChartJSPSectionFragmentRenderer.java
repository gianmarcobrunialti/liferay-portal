...
public class ViewAnalyticsFrequencyChartJSPSectionFragmentRenderer
	extends BaseJSPSectionFragmentRenderer<ViewAnalyticsFrequencyChartSectionDisplayContext> {
	...
	@Override
	protected ViewAnalyticsFrequencyChartSectionDisplayContext getDisplayContext(
		...
		return new ViewAnalyticsFrequencyChartSectionDisplayContext(
			httpServletRequest,
