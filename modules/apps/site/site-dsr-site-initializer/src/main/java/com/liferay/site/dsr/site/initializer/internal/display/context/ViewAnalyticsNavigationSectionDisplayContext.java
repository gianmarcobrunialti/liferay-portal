...
public class ViewAnalyticsNavigationSectionDisplayContext
	...
	public JSONObject getFilterSettingsJSONObject() {
		return JSONUtil.put(
			"disabled", false // _getConfigurationValue("disableFilters")
		).put(
			"interactable", true // _getConfigurationValue("userControlledFilters")
		).put(
			"persisted", true // _getConfigurationValue("persistFilters")
		);
	}
