...
import {
    AnalyticsFilters,
    DateRangePreset, IAnalyticsFilter,
    TAnalyticsFilter,
    TAnalyticsFilterValue,
    TDateRangeAnalyticsFilterValue,
    TDateRangePreset
} from "../types";
import DateRangeAnalyticsFilter
    from "../components/filters/DateRangeAnalyticsFilter";
...
export function toFilters(filtersJSONString: string | null): TAnalyticsFilter {
    ...
    try {
        ...
        return Object.entries(filterValues).reduce((filters, [key, valueObj]) => ({
            ...filters,
            [key]: {
                ...DEFAULT_FILTERS[key as AnalyticsFilters],
                ...valueObj,
            },
        }), DEFAULT_FILTERS) as TAnalyticsFilter;
    } catch(_ignore) {
...
export function toStoredFilters(filters: TAnalyticsFilter): TAnalyticsFilterValue {
