...
ViewAnalyticsRoomTrendAnalyticsSectionDisplayContext
	viewAnalyticsRoomTrendAnalyticsSectionDisplayContext = (ViewAnalyticsRoomTrendAnalyticsSectionDisplayContext)request.getAttribute(ViewAnalyticsRoomTrendAnalyticsSectionDisplayContext.class.getName());
%>
