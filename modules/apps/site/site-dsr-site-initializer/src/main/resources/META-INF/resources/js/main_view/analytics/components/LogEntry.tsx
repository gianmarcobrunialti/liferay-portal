...
const LogEntry: React.FC<ILogEntry> = (logEntry) => {
    return (
        <li className="timeline-item" key={logEntry.createDate}>
            <div className="panel">
                <div className={`sticker sticker-circle timeline-increment timeline-increment-${logEntry.type}`}>
                        <span className={`timeline-increment-icon timeline-increment-icon-${logEntry.type}`}>
                            <ClayIcon
                                className="log-icon"
                                symbol={
                                    logEntry.icon
