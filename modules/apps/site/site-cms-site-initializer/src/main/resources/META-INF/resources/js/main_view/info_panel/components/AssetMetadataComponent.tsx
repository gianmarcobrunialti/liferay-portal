...
const AssetMetadataComponent = () => {
	...
	const {objectEntries, type, title_i18n = {}}: IAssetTypeInfoPanelContext =
...
export default AssetMetadataComponent;
