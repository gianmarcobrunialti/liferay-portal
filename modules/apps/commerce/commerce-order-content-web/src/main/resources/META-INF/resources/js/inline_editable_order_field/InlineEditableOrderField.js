...
const InlineEditableOrderField = ({
	...
	const onSubmit = useCallback((event) => {
		...
		const submit = isOpenOrder
			...
			: CommerceServiceProvider.DeliveryOrderAPI('v1').updatePlacedOrderById;
	...
	}, [inputValue, isOpenOrder, onOpenChange]);

	return(
		<>
			<div className="d-flex align-items-center" id={`${namespace}inlineEditableOrderField`}>
