...
public class OrderActionsFragmentRenderer implements FragmentRenderer {
	...
	private List<DropdownItem> _getDropdownItems(
		...
		try {
			if (commerceOrder.isOpen()) {
				for (CommerceOrderImporterType commerceOrderImporterType :
					...
					boolean importerTypeEnabled = _isOrderActionEnabled(
						editableValues, fragmentRendererContext,
		...
		boolean printOrderEnabled = _isOrderActionEnabled(
			editableValues, fragmentRendererContext, "printOrder");
	...
	private boolean _isOrderActionEnabled(
		String editableValues, FragmentRendererContext fragmentRendererContext,
		String name) {
