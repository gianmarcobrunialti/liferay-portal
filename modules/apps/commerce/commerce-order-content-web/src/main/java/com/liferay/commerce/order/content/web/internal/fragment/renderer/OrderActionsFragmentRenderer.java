...
public class OrderActionsFragmentRenderer implements FragmentRenderer {
					...
					dropdownItems.add(
						DropdownItemBuilder.setHref(
							PortletURLBuilder.create(
								...
								"orderDetailURL", CommerceOrderInfoItemUtil.getCommerceOrderFriendlyURL(
									_friendlyURLSeparatorProviderSnapshot.get(), httpServletRequest) + commerceOrder.getCommerceOrderId()
							).setWindowState(
			...
			if (commerceOrder.isOpen() &&
				...
				dropdownItems.add(
					DropdownItemBuilder.setData(
						...
						_language.get(
							httpServletRequest, "remove-all-items")
					).setTarget(
						"submitWithConfirmation"
					).build());
			}
		...
		dropdownItems.add(
			DropdownItemBuilder.setHref(
				ResourceURLBuilder.createResourceURL(
					...
					CommerceOrderInfoItemUtil.getCommerceOrderFriendlyURL(
						_friendlyURLSeparatorProviderSnapshot.get(),
						httpServletRequest) + commerceOrder.getCommerceOrderId()
				).setResourceID(
	...
	private boolean _hasModelPermission(
		CommerceOrder commerceOrder, String action) throws PortalException {

		return _commerceOrderModelResourcePermission.contains(
			PermissionThreadLocal.getPermissionChecker(), commerceOrder, action);
	}
	...
	@Reference
	CommerceOrderImporterTypeRegistry _commerceOrderImporterTypeRegistry;
