		...
		if (fdsName.equals(CommerceOrderFragmentFDSNames.PENDING_ORDER_ITEMS)) {
			return Arrays.asList(
				new FDSActionDropdownItem(
					...
					_language.get(httpServletRequest, "view"), null,
					null, "link"),
				new FDSActionDropdownItem(
					StringPool.BLANK, "pencil", "edit",
					_language.get(httpServletRequest, "edit"), null,
					null, "link"),
				new FDSActionDropdownItem(
					"/o/headless-commerce-delivery-cart/v1.0/cart-items/{id}",
					"trash", "delete", _language.get(httpServletRequest, "remove"),
					"delete", null, "async")
			);
		}
		else if (fdsName.equals(CommerceOrderFragmentFDSNames.PLACED_ORDER_ITEMS)) {
			return Arrays.asList(
				new FDSActionDropdownItem(
					StringPool.BLANK, "view", "view",
					_language.get(httpServletRequest, "view"), null,
