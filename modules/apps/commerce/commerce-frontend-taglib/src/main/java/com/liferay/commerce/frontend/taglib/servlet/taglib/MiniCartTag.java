...
public class MiniCartTag extends IncludeTag {
	...
	protected void cleanUp() {
		...
		_toggleable = true;
		_undoCartItemDeletionDisabled = true;
		_views = new HashMap<>();
	}
	...
	protected void setAttributes(HttpServletRequest httpServletRequest) {
		...
		httpServletRequest.setAttribute(
			"liferay-commerce:cart:slowConnectionOrderFlowEnabled", _slowConnectionOrderFlowEnabled);
		httpServletRequest.setAttribute(
			"liferay-commerce:cart:siteDefaultURL", _siteDefaultURL);
		httpServletRequest.setAttribute(
			"liferay-commerce:cart:toggleable", _toggleable);
		httpServletRequest.setAttribute(
			"liferay-commerce:cart:undoCartItemDeletionDisabled", _undoCartItemDeletionDisabled);
	}
	...
	private boolean _slowConnectionOrderFlowEnabled = false;
	private boolean _toggleable = true;
	private boolean _undoCartItemDeletionDisabled = true;
