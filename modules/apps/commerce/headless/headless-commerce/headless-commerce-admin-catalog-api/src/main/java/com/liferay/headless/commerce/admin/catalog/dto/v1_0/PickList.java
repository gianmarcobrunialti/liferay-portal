 ...
 */
@Generated("")
@GraphQLName("PickList")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PickList")
public class PickList implements Serializable {

	public static PickList toDTO(String json) {
		return ObjectMapperUtil.readValue(PickList.class, json);
	}

	public static PickList unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(PickList.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), pickList.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.catalog.dto.v1_0.PickList",
		name = "x-class-name"
	)
